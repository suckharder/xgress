module github.com/suckharder/xgress
...
// Mirror Traefik's own replace directives. These are required because Traefik's
// go.mod replaces these module paths and those replacements do not propagate to
// consumers that import Traefik as a library.
replace (
	...
	// Vendored copy of Traefik's local-only dynamic/ext extension module.
